...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\auser_id\x18\x02 \x01(\tR\x06userId2\xe1\x02\n" +
	"\x04Auth\x12A\n" +
	...
	"\fRefreshToken\x12\x1c.auth.v1.RefreshTokenRequest\x1a\x1d.auth.v1.RefreshTokenResponse\"\x00\x12P\n" +
	"\rValidateToken\x12\x1d.auth.v1.ValidateTokenRequest\x1a\x1e.auth.v1.ValidateTokenResponse\"\x00B\x17Z\x15gen/go/auth/v1;authv1b\x06proto3"
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	...
	8, // 4: auth.v1.Auth.ValidateToken:input_type -> auth.v1.ValidateTokenRequest
	...
	7, // 8: auth.v1.Auth.RefreshToken:output_type -> auth.v1.RefreshTokenResponse
	9, // 9: auth.v1.Auth.ValidateToken:output_type -> auth.v1.ValidateTokenResponse
